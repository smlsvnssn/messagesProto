...
export declare type RigidBodyProperties = Omit<
	TransformableObjectProperties,
	'object'
> & {
	/**
...
export declare type ColliderProperties<Shape extends ColliderShapes> = Omit<
	TransformableObjectProperties,
	'object'
> & {
	shape: Shape
...
export declare type AutoCollidersProperties = Omit<
	ColliderProperties<AutoCollidersShapes>,
	'args'
>
...
export declare type AttractorProperties = Omit<
	TransformableObjectProperties,
	'object'
> & {
	/**
