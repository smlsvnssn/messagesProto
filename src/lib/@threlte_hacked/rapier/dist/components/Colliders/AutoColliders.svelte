<script>
	...
	import { SceneGraphObject } from '$lib/@threlte_hacked/core'
	...
	const { world, addColliderToContext, removeColliderFromContext } =
		useRapier()
	export let colliders = []
	const collisionGroups = useCollisionGroups()
	const dispatcher = createEventDispatcher()
	const { hasEventListeners: colliderHasEventListeners } =
