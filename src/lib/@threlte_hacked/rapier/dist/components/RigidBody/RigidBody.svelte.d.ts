...
declare const __propDef: {
	props: {
		...
		type?:
			| import('../../lib/parseRigidBodyType').RigidBodyTypeString
			| undefined
		canSleep?: boolean | undefined
		linearVelocity?:
			| import('$lib/@threlte_hacked/core').Position
			| undefined
		angularVelocity?:
			| import('$lib/@threlte_hacked/core').Rotation
			| undefined
		...
		enabledRotations?:
			| import('../../types/components').Boolean3Array
			| undefined
		enabledTranslations?:
			| import('../../types/components').Boolean3Array
			| undefined
...
export default class RigidBody extends SvelteComponentTyped<
	RigidBodyProps,
	RigidBodyEvents,
	RigidBodySlots
> {}
