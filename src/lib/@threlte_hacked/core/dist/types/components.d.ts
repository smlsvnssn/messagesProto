...
import type { LineMaterial } from '../hacked_three_jsm_examples/lines/LineMaterial'
import type { OrbitControls } from '../hacked_three_jsm_examples/controls/OrbitControls'
import type { Pass } from '../hacked_three_jsm_examples/postprocessing/Pass'
...
export declare type Object3DInstanceProperties = SceneGraphObjectProperties &
...
export declare type MeshInstanceProperties = Omit<
...
export declare type LineInstanceProperties = Omit<
...
export declare type LightInstanceProperties = Omit<
	Object3DInstanceProperties,
	'object'
> & {
	light: Light
...
export declare type CameraInstanceProperties = Omit<
	Object3DInstanceProperties,
	'object'
> & {
	camera: Camera
...
export declare type OrthographicCameraProperties = Omit<
...
export declare type PerspectiveCameraProperties = Omit<
	CameraInstanceProperties,
	'camera'
> & {
	near?: number
...
export declare type AmbientLightProperties = Omit<
	LightInstanceProperties,
	'light'
>
export declare type DirectionalLightProperties = Omit<
	LightInstanceProperties,
...
export declare type HemisphereLightProperties = Omit<
	LightInstanceProperties,
	'color' | 'light'
> & {
...
export declare type PointLightProperties = Omit<
	LightInstanceProperties,
	'light' | 'castShadow'
> & {
	distance?: number
...
export declare type SpotLightProperties = Omit<
	LightInstanceProperties,
...
export declare type LineSegmentsProperties = Omit<
...
export declare type InstancedMeshProperties = Omit<
...
export declare type InstanceProperties = Omit<
	TransformableObjectProperties,
	'object'
> & {
	color?: ColorRepresentation
...
export declare type Object3DProperties = Omit<
	Object3DInstanceProperties,
	'object'
>
export declare type AudioListenerProperties = Omit<
	Object3DInstanceProperties,
	'object'
> & {
	id?: string
...
declare type AudioSource =
	...
	| MediaStream
export declare type AudioInstanceProperties<
...
export declare type AudioProperties = Omit<
	SetOptional<AudioInstanceProperties<Audio>, 'play' | 'pause' | 'stop'>,
	'audio'
> & {
	id?: string
}
export declare type PositionalAudioProperties = Omit<
	SetOptional<
		AudioInstanceProperties<PositionalAudio>,
		'play' | 'pause' | 'stop'
	>,
	'audio'
> & {
