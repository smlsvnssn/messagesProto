...
import type {
	EffectComposer,
	Pass,
} from '../../hacked_three_jsm_examples/postprocessing/EffectComposer'
...
declare const createEventDispatcherType: () => <
	EventKey extends keyof ThreltePointerEventMap,
>(
	type: EventKey,
	detail?: ThreltePointerEventMap[EventKey] | undefined,
	options?: import('svelte/internal').DispatchOptions | undefined,
) => boolean
export declare type InteractiveObjectEventDispatcher = ReturnType<
	typeof createEventDispatcherType
>
...
export declare type ThrelteLayers =
	| 0
	| 1
	| 2
	| 3
...
export declare type ThrelteUseLoader = <T extends typeof Loader>(
	loader: T,
