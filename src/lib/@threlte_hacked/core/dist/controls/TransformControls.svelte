<script>
	...
	import { TransformControls } from '../hacked_three_jsm_examples/controls/TransformControls'
	...
	const eventMap = {
		...
		'worldPositionStart-changed': e =>
			dispatch('worldPositionStart-changed', e),
		'worldQuaternion-changed': e => dispatch('worldQuaternion-changed', e),
		'worldQuaternionStart-changed': e =>
			dispatch('worldQuaternionStart-changed', e),
		'cameraPosition-changed': e => dispatch('cameraPosition-changed', e),
		'cameraQuaternion-changed': e =>
			dispatch('cameraQuaternion-changed', e),
