...
import type { GLTF } from '../hacked_three_jsm_examples/loaders/GLTFLoader'
 ...
 * ```svelte
 * <script lang="ts">
 *   import { GLTF, useGltfAnimations } from '$lib/@threlte_hacked/extras'
 *
 ...
 * @returns
 */
export declare function useGltfAnimations<
	T extends string,
	Actions = Partial<Record<T, AnimationAction>>,
