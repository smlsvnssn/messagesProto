<script>
	...
	import { KTX2Loader } from '../../hacked_three_jsm_examples/loaders/KTX2Loader'
	import { MeshoptDecoder } from '../../hacked_three_jsm_examples/libs/meshopt_decoder.module.js'
