<script>
	...
	import { HorizontalBlurShader } from '../../hacked_three_jsm_examples/shaders/HorizontalBlurShader'
	import { VerticalBlurShader } from '../../hacked_three_jsm_examples/shaders/VerticalBlurShader'
	...
	const planeGeometry = useMemo(() => {
		return new PlaneBufferGeometry($scaledWidth, $scaledHeight).rotateX(
			Math.PI / 2,
		)
	})
